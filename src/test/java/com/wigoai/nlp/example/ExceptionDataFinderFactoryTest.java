...
public class ExceptionDataFinderFactoryTest {
    private static final String regx = "(기자[^가-힣a-zA-Z0-9]{1,10})([0-9a-zA-Z][0-9a-zA-Z\\_\\-\\.]+[0-9a-zA-Z]@[0-9a-zA-Z][0-9a-zA-Z\\_\\-]*[0-9a-zA-Z](\\.[a-zA-Z]{2,6}){1,2}([^가-힣a-zA-Z0-9]{0,10}))?";
